...
def test_answer():
    ...
    sc_model=bulk_model.make_supercell([[1,0],[0,num_wire]],to_home=False,to_home_suppress_warning=True)
    ...
    finite_model_orthogonalized=finite_model.change_nonperiodic_vector(np_dir=1, new_latt_vec=None,to_home_suppress_warning=True)
    ...
    finite_model_arb=finite_model.change_nonperiodic_vector(np_dir=1, new_latt_vec=[-1.3,4.8],to_home_suppress_warning=True)
