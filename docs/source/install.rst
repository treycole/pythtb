...
* :download:`pythtb-2.0.0.tar.gz <misc/pythtb-2.0.0.tar.gz>`
* :download:`pythtb-2.0.0.zip <misc/pythtb-2.0.0.zip>`

and unpack it with one of these commands::

   tar -zxf pythtb-2.0.0.tar.gz
   unzip pythtb-2.0.0.zip
...
If you do not have Python installed, or it is not at Version 3.10 or
...
any needed modules. If you do not have a package manager, you can try going to the
...
Versions 1.7.1 - 2.0.0 above are compatible with both Python 2.7 - 3.10.
Version 2.0.0 only guarantees compatibility with Python 3.10 and above.

However, if you need to install an old version of the code, you can find it below.
