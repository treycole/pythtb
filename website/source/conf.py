# -*- coding: utf-8 -*-
#
# Python Tight Binding (PythTB) documentation build configuration file, created by
# sphinx-quickstart on Thu Aug 30 13:06:05 2012.
#
...
project = u'PythTB'
copyright = u'2016, Sinisa Coh and David Vanderbilt'
